  ...
  return (
    <section aria-label="Carga de archivo" className="space-y-3">
      <div
        ...
        onDrop={handleDrop}
        className={cn(
          'rounded-lg border-2 border-dashed bg-white p-5 text-center transition',
          isDragging ? 'border-brand-500 bg-brand-50' : 'border-border',
          error ? 'border-danger bg-danger/5' : '',
        )}
      >
        <div className="mx-auto inline-flex h-10 w-10 items-center justify-center rounded-full bg-brand-50 text-brand-500">
        ...
        <p className="mt-3 text-xl font-semibold leading-tight text-text">Suba su comprobante</p>
        ...
        <div className="mt-4">
          <button
            ...
            className="inline-flex items-center justify-center rounded-lg border border-brand-300 bg-white px-5 py-2.5 text-sm font-semibold text-brand-500 transition hover:bg-brand-50"
          >
